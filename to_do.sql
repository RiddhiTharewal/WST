...
<head>
  ...
  <link rel="shortcut icon" href="favicon.ico" type="image/x-icon">
    ...
    <link rel="stylesheet" type="text/css" href="./themes/pmahomme/css/theme.css?v=5.1.3&nocache=2344505321ltr&server=1">
...
<body>
  ...
  <div class="pma_quick_warp"><div class="drop_list"><button title="Recent tables" class="drop_button btn">Recent</button><ul id="pma_recent_list"><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=practice&table=to_do">`practice`.`to_do`</a></li></ul></div><div class="drop_list"><button title="Favorite tables" class="drop_button btn">Favorites</button><ul id="pma_favorite_list"><li class="warp_link">There are no favorite tables.</li></ul></div><div class="clearfloat"></div></div>
...
<div id='pma_navigation_tree_content'>
  ...
  <input type="hidden" name="tab_hash" value="">
    ...
    <input type="hidden" name="token" value="32416e2c752d3053353e254c622a2355">
  ...
  <div id="pma_console_container">
    <div id="pma_console">
                ...
                <div class="message welcome">
                    ...
                    <span class="hide" id="instructions-1">
                        Press Enter to execute query                    </span>
                            ...
                            targetdb="practice" targettable="to_do">
            ...
            Queried time
                            ...
                            <span class="query">CREATE TABLE `practice`.`to_do` ( `category` VARCHAR(255) NOT NULL ,  `task` VARCHAR(255) NOT NULL ,  `priority` INT(2) NOT NULL ,  `description` TEXT NOT NULL ,  `complete` INT(1) NOT NULL ,    PRIMARY KEY  (`task`)) ENGINE = InnoDB;</span>
                        </div>
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `to_do`</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="practice" targettable="to_do">
                            <div class="action_content">
            ...
            Queried time
                            ...
                            <span class="query">DELETE FROM `to_do` WHERE 0;</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="practice" targettable="to_do">
                            <div class="action_content">
            ...
            Queried time
                            ...
                            <span class="query">DELETE FROM `to_do` WHERE `to_do`.`task` = &#039;hcshdish&#039;</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="practice" targettable="to_do">
                            <div class="action_content">
